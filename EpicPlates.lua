...
function EpicPlates:UpdateAuras(unit)
    ...
    for i = 1, 40 do
        ...
        if aura.spellId == 34914 or aura.name == "Vampiric Touch" or aura.spellId == 589 or aura.name == "Power Word: Pain" then
...
function EpicPlates:IsAuraFiltered(spellName, spellID, casterName, remainingTime)
    ...
    if spellID == 34914 or spellName == "Vampiric Touch" then
        return false
    end
